...
class CertificateGenerator {
    ...
    async createCanvasWithTemplate() {
        ...
        // Match CSS position: .name-overlay { top: 44% }
        const nameY = canvas.height * 0.44; // 44% from top
        const clubY = canvas.height * 0.555; // not used
    ...
    createFallbackCanvas() {
        ...
        if (name) {
            ...
            ctx.textAlign = 'center';
            ctx.textBaseline = 'middle';
            ctx.fillText(name, canvas.width / 2, canvas.height * 0.44);
        }
